...
public class CheckoutController {
    ...
    public void createOrder( ) {         // Should get cart object while linking
        Cart cart = new Cart();
        cart.setQuantity(2);
        cart.setCartID(999);
    ...
    public void getshipment(/*@RequestBody Shipment shipmentItem*/) {
        Orders orders = restTemplate.getForObject("http://localhost:8084/checkout-microservice/CreateOrder", Orders.class);
